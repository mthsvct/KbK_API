...
class Comanda(Base):
    ...
    dataFechamento = Column(DateTime, default=None)
    statusPagamento = Column(String) # PENDENTE, PAGO, PARCIAL
    ...
    def __repr__(self): return f"<Comanda: {self.id} - {self.cliente.nome}>"